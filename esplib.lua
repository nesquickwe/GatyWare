...
-- Try to load image from local executor assets first, fallback to GitHub download
local IMAGE_URL
...
local function createEsp(player)
    ...
    cache[player]["imagedrawing"] = create("Image", {
